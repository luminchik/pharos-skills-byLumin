...
export function evaluateMainnetAutoConfirm(policy, request) {
  ...
  if (actionConfig.unlimited === true || isUnlimitedAmountPolicy(actionConfig.maxAmount) || isUnlimitedAmountPolicy(actionConfig.maxFromAmount)) {
    return {
      allowed: true,
      source,
